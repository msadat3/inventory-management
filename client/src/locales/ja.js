export default {
  ...
  restocking: {
    ...
    budgetCard: '利用可能な予算',
    budgetHelper: 'スライダーをドラッグして補充予算を設定してください。',
    ...
    noGap: '予測需要はすべて現在の在庫で賄えます。',
    orderPlaced: '注文 {orderNumber} を {total} で送信しました。',
    viewInOrders: '注文タブで表示',
    subtitle: '不足数（予測または発注点のうち大きい方）でランク付け。数量は予算に比例してスケーリングされます。',
    table: {
      sku: 'SKU',
      name: '品目',
      category: 'カテゴリ',
